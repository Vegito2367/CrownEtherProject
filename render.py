...
class ExportUnit:
    def __init__(
        self, file, singleProperty, atoms1, doubleProperty1, atoms2, doubleProperty2
    ):
        self.file = file
...
class Render:
    ...
    def barGraphFrequencies(
        self, xData, yData, totalCount, title, xLabel, yLabel, ylabel2
    ):
        fig, ax1 = plt.subplots()
    ...
    def barGraph(self, xData, yData, title, xLabel, yLabel):
        ...
        ax1.bar(
            xData, yData, color="blue", alpha=0.6, edgecolor="black", width=bar_width
        )
        ax1.set_xlabel(xLabel)
        ax1.set_ylabel(yLabel)
        plt.title(title)
    ...
    def barGraphHistogramPercentage(self, yData, totalCount, title, xLabel, yLabel):
        ...
        counts, bins, patches = ax1.hist(
            yData, bins=5, edgecolor="black", color="blue", alpha=0.6
        )
        ax1.set_xlabel(xLabel)
        ax1.set_ylabel(yLabel, color="blue")
        ax1.set_title(title)
